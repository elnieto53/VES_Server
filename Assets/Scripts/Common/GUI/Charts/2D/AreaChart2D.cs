namespace VESCharts
{
    ...
    public class AreaChart2D : IChart2D
    {
        ...
        public AreaChart2D(ChartAxes2D axes, int depth)
        {
            this.axes = axes;
            ...
            meshRenderer.material = (Material)Resources.Load(ResourcesPath.Material.transparentBlue);
        ...
        public void Draw()
        {
            ...
            for (int i = 0; i < segments; i++)
            {
                ...
                vertices[i * 4 + 2] = axes.GetCoordinates(points[i + 1]);
